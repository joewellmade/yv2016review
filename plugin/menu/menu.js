...
var RevealMenu = window.RevealMenu || (function(){
	...
	loadResource(options.path + '/font-awesome-4.3.0/css/font-awesome.min.css', 'stylesheet', function() {
		...
		if (!bowser.msie || bowser.version >= 9) {
			...
			var toolbar = $('<p class="menu-text2"><a href="#">EXIT</a></p>').prependTo($('.slide-menu'));
			var buttons = 0;
			...
			$('<li class="menu-bottom"><a href="http://www.youngvic.org/"><p class="h1">Return to Young Vic site</p></a><div class="social-buttons"><a href="https://www.facebook.com/youngvictheatre"><img class="social-icon" src="img/icons/facebook.png"/></a><a href="https://twitter.com/youngvictheatre"><img class="social-icon" src="img/icons/twitter.png"/></a><a href="https://www.youtube.com/user/YoungVicLondon"><img class="social-icon" src="img/icons/youtube.png"/></a><a href="https://www.instagram.com/youngvictheatre/"><img class="social-icon" src="img/icons/instagram.png"/></a><a href="https://youngviclondon.wordpress.com/"><img class="social-icon" src="img/icons/wordpress.png"/></a></div></li>').appendTo(items);
			...
			if (openButton) {
				// add menu button
				$('<div class="slide-menu-button"><a href="#"><p class="menu-text">MENU</p></a></div>')
					.appendTo($('.reveal'))
					.click(openMenu);
			}
